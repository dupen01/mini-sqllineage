...
class SqlHelper:
    """SQL helper class for parsing and analyzing SQL statements."""
    ...
    def split(sql: str) -> list[str]:
        ...
        Example:
            >>> SqlHelper.split("SELECT 1; SELECT 2;")
            ["SELECT 1", " SELECT 2"]
        """
        result = []
        # 嵌套注释的层级数
    ...
    def get_source_target_tables(self, sql: str) -> dict[str, list[str]] | None:
        """
